...
export default function DriverSignup() {
    ...
    const validateForm = () => {
        ...
        // Vehicle and License are optional in original, keeping them optional but validated if present
                ...
                >
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={styles.headerTitles}>
                            <Text style={styles.welcomeText}>Driver Registration</Text>
                            <Text style={styles.subtitleText}>Start earning with Chardho</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <View style={styles.footer}>
                            ...
                            <TouchableOpacity onPress={() => router.push("/login/driver" as any)}>
